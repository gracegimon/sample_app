...
before(:each) do
 @attr= {
  ...
  it "should create a new instance given a valid attribute" do
  	User.create!(@attr)
  	# Adding The bang raises an ActiveRecord exception
  	# if the creation fails.
  end
  it "should require a name" do
  	no_name_user = User.new(@attr.merge(:name=>""))
  	no_name_user.should_not be_valid #Boolean version of valid?
  end
...
describe "password encryption" do
  ...
  #After adding a migration, it should update
  # the development db and then the test db
...
describe "micropost associations" do
  ...
  describe "relationships" do
    ...
    it "should have a relationships attr" do
